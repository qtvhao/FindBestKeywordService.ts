...
export class FindBestKeywordService {
    apiClient;
    BASE_URL = 'https://http-erabu-eidos-production-80.schnworks.com';
    constructor() {
     ...
     */
    async startFindBestKeywordJob(prompt) {
        try {
     ...
     */
    async getFindBestKeywordJob(jobId) {
        try {
     ...
     */
    async pollFindBestKeywordJob(jobId, interval = 3000, timeout = 60000) {
     ...
     */
    async runFindBestKeyword(prompt, interval = 3000, timeout = 60000) {
        try {
